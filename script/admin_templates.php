...
<:: reverse_proxy_misconfigured_alert ::>
            ...
            <div role="tabpanel" class="tab-pane" id="security">
                ...
                <div class="form-group">
                    <label>
                        ...
                        Use <a href="http://nastyhosts.com">NastyHosts.com</a> - external IP address check service
                    </label>
                </div>
...
<p class="alert alert-danger"><b><em>Reverse Proxy</em> provider setting automatically changed back to None, because people viewing your faucet without reverse proxy were detected</b>.<br>Make sure your reverse proxy is configured correctly!</p>
TEMPLATE;

$reverse_proxy_misconfigured_alert_template = <<<TEMPLATE
<p class="alert alert-warning">It seems that you're using <:: reverse_proxy_provider ::> as your Reverse Proxy provider. You should configure it in <em>Advanced</em> tab or timer won't work correctly.</p>
TEMPLATE;
